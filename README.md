...
* `teads-htb.js` - This is your partner module file, by default it contains a template divided into multiple sections which need to be completed.
* `teads-htb-validator.js` - This is the validator file for the configuration object that will be passed into your module.
* `teads-htb-exports.js` - A file that contains all of the modules exports (i.e. any functions that need to be exposed to the outside world).

## <a name='gettingStarted'></a>Getting Started
1. <b>Complete the teads-htb.js file</b>
    * teads-htb.js is where all of your adapter code will live.
...
2. <b>Complete the teads-htb-validator.js file</b>
...
3. <b>Complete the teads-htb-exports.js file</b>
    * This file will contain any functions that need to be exported or exposed to the outside world. Things like render functions, custom callbacks, etc. Any legacy render functions will also need to be exposed here. Anything added to the `shellInterface.TeadsHtb` will be accessible through `window.headertag.TeadsHtb`
...
In this section you will be filling out the teads-htb.js, teads-htb-exports.js, and the teads-htb-validator.js files to create your module.

### Step 0: Config Validation (`teads-htb-validator.js`)
...
### Step 2: Generate Request URL (`teads-htb.js`)
...
### Step 3: Response Callback (`teads-htb.js`)
...
### Step 4: Parsing and Storing Demand (`teads-htb.js`)
...
```javascript
{
    ...
    "targetingType": "slot"
    "targeting" : {
        "ix_tds_id": ["_230l09jd2"],
        "ix_tds_cpm": ["300x250_2.50"]
    },
    "price": 2.50,
    "size": [300,250],
...
### Step 5: Rendering Pixel (`teads-htb.js`)
...
### Step 6: Exports (`teads-htb-exports.js`)
...
```javascript
shellInterface.TeadsHtb = { //shell interface is the window variable that is accessible through the window object, currently this will always be window.headertag
...
```javascript
if (__directInterface.Layers.PartnersLayer.Partners.TeadsHtb) {
    shellInterface.TeadsHtb = shellInterface.TeadsHtb || {};
    shellInterface.TeadsHtb.adResponseCallback = __directInterface.Layers.PartnersLayer.Partners.TeadsHtb.adResponseCallback;
}
```
...
if (__directInterface.Layers.PartnersLayer.Partners.TeadsHtb) {
    shellInterface.TeadsHtb = shellInterface.TeadsHtb || {};
    shellInterface.TeadsHtb.adResponseCallbacks = __directInterface.Layers.PartnersLayer.Partners.TeadsHtb.adResponseCallbacks;
}
```
